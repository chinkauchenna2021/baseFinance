<template>
   <MainLayout>
       ...
       <div class="w-full flex justify-center">
          <Panel_Holder senderTokenImage="USDC.png" baseTokenImage="ETH.png" title="USDC/ETH" description="This is for users who are willing to hedge USDC as a collateral with the platform for ETH"/>  
       </div>
