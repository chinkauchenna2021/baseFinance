<template>
   <MainLayout>
       ...
       <div class="w-full flex flex-row justify-center items-center h-[180px]">
         ...
         <div class="w-full">
           <div class='w-full h-fit text-xs text-center lg:text-left lg:text-3xl font-extrabold py-4 capitalize' id="title">
       ...
       <div class="w-full flex justify-center">
          <Panel_Holder senderTokenImage="USDC.png" baseTokenImage="ETH.png" title="USDC/ETH" description="The USDC/ETH is for users who are in need of 
          Eth for and are willing to store USDC as a collaterial with the platform"/>  
       </div>
