<template>
  <div class="border items-center justify-between px-4 flex flex-row border-slate-200 h-20 mt-10 w-full lg:w-11/12  rounded-full">
      <div class="w-fit h-fit flex relative hover:space-x-[3px] transit cursor-pointer">
