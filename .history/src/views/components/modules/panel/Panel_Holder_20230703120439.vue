<template>
  <div class="border items-center  px-4 flex flex-row border-slate-200 h-20 mt-10 w-full lg:w-11/12  rounded-full">
      ...
      <div class="ml-5 font-bold text-lg text-black/70">
          {{titles}}
      </div>
      <div class="h-full w-3/12 flex flex-row items-center lg:ml-4">
      <span class="text-sm font-semibold text-black/50"> Description:</span>
      <div class=" text-xs mx-2 text-center">
       {{description}}
      </div>
      </div>
  </div>
